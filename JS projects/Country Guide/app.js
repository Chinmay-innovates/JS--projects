...
searchBtn.addEventListener("click", () => {
  ...
  fetch(finalURL)
    ...
    .then((data) => {
      ...
      //   );
      //   console.log(
      //     Object.values(data[0].borders).toString().split(",").join(", ")
      //   );
    ...
    .catch(() => {
      if (countryName.length == "0") {
        result.innerHTML = `<h3>The input feild cant be empty</h3>`;
      } else {
        result.innerHTML = `<h3>please a valid country name </h3>`;
      }
    });
});
